...
user = {
    ...
    file_manager = "thunar",
    editor = "code",
    email_client = "chromium gmail.com",
    music_client = "wine C:/Program Files/iTunes/iTunes.exe",

    -- >> Web Search <<
    web_search_cmd = "xdg-open https://www.searx.be/search?q=",
