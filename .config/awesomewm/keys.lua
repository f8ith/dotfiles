...
--    awful.key({ superkey }, "F7", function() awful.spawn.with_shell("freeze chromium") end,
--        {description = "send STOP signal to all chromium processes", group = "other"}),
--    awful.key({ superkey, shiftkey }, "F7", function() awful.spawn.with_shell("freeze -u chromium") end,
--        {description = "send CONT signal to all chromium processes", group = "other"}),
