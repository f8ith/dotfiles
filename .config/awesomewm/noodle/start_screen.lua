...
user_text.font = "Google Sans bold 18"
...
host_text.font = "Google Sans italic 18"
...
styles.header  = { fg_color = beautiful.xcolor7,
    ...
    -- markup   = function(t) return '<b>' .. t .. '</b>' end,
    markup   = function(t) return '<span font_desc="Google Sans bold 24">' .. t .. '</span>' end,
}
...
hours.font = "Google Sans bold 30"
hours.align = "center"
hours.valign = "center"
local minutes = wibox.widget.textclock("  %M")
minutes.font = "Google Sans 30"
...
day_of_the_week.font = "Google Sans italic 20"
...
day_of_the_month.font = "Google Sans bold 30"
...
local function create_bookmark(name, path)
    ...
    bookmark.font = "Google Sans bold 16"
