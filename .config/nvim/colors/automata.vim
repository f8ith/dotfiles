  ...
  let s:guishade0 = "#e2dbc0"
  let s:guishade1 = "#cac4af"
  let s:guishade2 = "#959183"
  let s:guishade3 = "#838072"
  let s:guishade4 = "#807d6f"
  let s:guishade5 = "#67655a"
  let s:guishade6 = "#4f4d45"
  let s:guishade7 = "#363530"
  ...
  exec "hi Normal guifg=".s:guishade7." guibg=".s:guishade0
  exec "hi Normal ctermfg=".s:ctermshade7." ctermbg=".s:ctermshade0
  ...
  exec "hi Search guibg=".s:guishade1
  exec "hi Search ctermbg=".s:ctermshade1
