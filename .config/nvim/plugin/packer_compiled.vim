...
_G.packer_plugins = {
  ...
  ["vim-hexokinase"] = {
    loaded = true,
    path = "/Users/faith/.local/share/nvim/site/pack/packer/start/vim-hexokinase"
  },
  ["vim-polyglot"] = {
    loaded = true,
