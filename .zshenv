...
export PATH="/opt/lutris-ge-6.19-1-x86_64/bin:/usr/local/Cellar/mingw-w64/8.0.2/toolchain-x86_64/bin:$HOME/bin:$HOME/go/bin/:$HOME/.cargo/bin:$HOME/.local/bin:$HOME/Library/Python/3.9/bin:$HOME/.npm/bin:$PATH"
