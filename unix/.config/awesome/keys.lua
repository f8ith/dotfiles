...
--     awful.key("XF86AudioNext", function() awful.spawn.with_shell("mpc -q next") end,
--         {description = "next song", group = "media"}),
--     awful.key("XF86AudioPrev", function() awful.spawn.with_shell("mpc -q prev") end,
--         {description = "previous song", group = "media"}),
--     awful.key("XF86AudioPlay", function() awful.spawn.with_shell("mpc -q toggle") end,
--         {description = "toggle pause/play", group = "media"}),
--     awful.key({ superkey, shiftkey }, "period", function() awful.spawn.with_shell("mpvc next") end,
--         {description = "mpv next song", group = "media"}),
--     awful.key({ superkey, shiftkey }, "comma", function() awful.spawn.with_shell("mpvc prev") end,
...
--         {description = "mpv toggle pause/play", group = "media"}),
    ...
    awful.key({ ctrlkey }, "Print",
        function()
            awful.spawn.with_shell("vfio a && notify-send 'Attached usb device'")
        end,
        {description = "process monitor", group = "launcher"})
)
...
keys.clientkeys = gears.table.join(
    ...
    awful.key({ ctrlkey, altkey   }, "c",
        function ()
            awful.spawn.with_shell("toggle picom -b --experimental-backends")
        end,
